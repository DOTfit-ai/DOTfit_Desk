...
TOOL_MAPPING = {
    ...
    "forecast": "check_rain_status",
    "temperature": "check_rain_status",
    ...
    "date": "generate_calendar",
    "month": "generate_calendar",
    "year": "generate_calendar",

    "mapreviews": "fetch_reviews",
    "reviews": "fetch_reviews",

    "search": "fetch_web_links",
    "websearch": "fetch_web_links",
